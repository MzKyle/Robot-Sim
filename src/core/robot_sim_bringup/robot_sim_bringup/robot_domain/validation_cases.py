...
from robot_sim_bringup.common.registry import resolve_validation_case_path as registry_case_path
from robot_sim_bringup.common.schema_validation import validate_config_schema
...
def _resolve_scene_ref(spec, field_name):
    if isinstance(spec, dict):
        if spec.get("path"):
            ...
            from robot_sim_bringup.common.registry import package_share_directory
